...
class Process:
    def __init__(self, id, n1, n2, opcion, finalizacion, tiempo,  tiempo_transcurrido, tiempo_bloqueado, tiempo_llegada, tiempo_finalizacion, tiempo_respuesta,tiempo_respuesta_bandera,quantum):
...
def crear_proceso(id):
    ...
    quantum = 0
    proceso = Process(id,n1,n2,opcion,finalizacion,tiempo,tiempo_transcurrido,tiempo_bloqueado,tiempo_llegada,tiempo_finalizacion,tiempo_respuesta,tiempo_respuesta_bandera,quantum)
    return id, proceso
...
def main():
  ...
  bloqueados = []
  null_process = Process("N/A","N/A","N/A","N/A",0,0,0,0,0,0,0,0,0)
  id = 0
